...
project = u'pybot-core from POBOT'
copyright = u'2015, Eric Pascual'
author = u'Eric Pascual'
basename = 'pobot-pybot-core'
...
latex_documents = [
  (master_doc, basename + '.tex', project + u' Documentation',
...
texinfo_documents = [
  (master_doc, basename, project + u' Documentation',
   author, project, 'Common definitions and helpers for the POBOT-PyBot collection.',
   'Miscellaneous'),
]
